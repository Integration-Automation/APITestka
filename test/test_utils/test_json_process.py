...
def test_reformat_valid_json_string():
    ...
    test_json_string = '[["get", "http://httpbin.org/get"]]'
    result = reformat_json(test_json_string)
    assert isinstance(result, str)
    parsed = json.loads(result)
    assert parsed == [["get", "http://httpbin.org/get"]]
...
def test_reformat_read_json(tmp_path):
    ...
    test_list = [["AT_test_api_method", {"http_method": "get", "test_url": "http://httpbin.org/get"}]]
