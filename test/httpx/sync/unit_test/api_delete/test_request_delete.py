...
if __name__ == "__main__":
    test_response = test_api_method_httpx("delete", "http://httpbin.org/delete")
    ...
    try:
        test_response = test_api_method_httpx("delete", "wadwaddawdwa")
    except requests.exceptions.MissingSchema as error:
        print(repr(error), file=sys.stderr)
    try:
        test_response = test_api_method_httpx("dwadadwawd", "delete")
