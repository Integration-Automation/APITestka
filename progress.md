...
Cross-repo and workspace items live in `D:\Codes\progress.md` (relevant here: X-1, X-7, X-11, X-12, X-16).
...
- **#4** The dependabot branch `pyside6-6.11.1` (2026-05-14) is not merged (see workspace X-1).
